...
zns0_img="$PWD/../backing-files/btrfs/zns0.raw"
zns1_img="$PWD/../backing-files/btrfs/zns1.raw"
zns2_img="$PWD/../backing-files/btrfs/zns2.raw"
zns3_img="$PWD/../backing-files/btrfs/zns3.raw"
zns4_img="$PWD/../backing-files/btrfs/zns4.raw"
zns5_img="$PWD/../backing-files/btrfs/zns5.raw"

ubuntu_img="$PWD/../backing-files/btrfs/ubuntu.img"
kernel_img="$PWD/../backing-files/linux5.18img/kernel/arch/x86/boot/bzImage"
